...
const Component = styled(Card)`
    box-shadow: 0 2px 5px 0 rgb(0 0 0 / 18%), 0 2px 10px 0 rgb(0 0 0 / 13%);
    margin-bottom: 20px;
`;
            ...
            <Container>
                <Grid container>
                    ...
                    <RightContainer lg={7} md={7} sm={7} xs={12} item>
                        ...
                        <Publisher>
                            read more at <a style={{textDecoration:"none", color:'#000'}} href={data.link} rel="noreferrer" target='_blank'><b>{data.publisher}</b></a>
                        </Publisher>
                    </RightContainer>
                </Grid>
            </Container>
